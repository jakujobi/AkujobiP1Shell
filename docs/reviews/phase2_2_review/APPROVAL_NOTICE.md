...
1.  SUCCESS **Changelog had wrong test class count** (said 8, actually 10)
   - Fixed in version 0.3.1

2.  SUCCESS **Line counts were off by 1**
   - Fixed in version 0.3.1
